                            ...
                            <?php
                                ...
                                if( isset( $_SESSION['apct_message'] ) ) { ?>
                                    <div class="apccss-message">
                                        <p><?php echo esc_html($_SESSION['apct_message']); unset( $_SESSION['apct_message'] ); ?></p>
                                    </div>
                                <?php } ?>
                             <div class="inside">
                              <?php global $wpdb; 
                               $table_name = $wpdb->prefix . "apct_testimonial_detail";
                               $testimonial_detail = $wpdb->get_results($wpdb->prepare("SELECT * FROM $table_name WHERE id=%d",$_GET['id']));
                               ...
                               <form method="post" action="<?php echo admin_url() . 'admin-post.php' ?>" enctype="multipart/form-data" class="apct-testimonial-form">
                                        ...
                                        <input type="hidden" name="current_post_id" value="<?php echo intval($_GET['id']);?>" />
                                        ...
                                        <div class="apct-testimonial-input-field">
                                            ...
                                            <div class="apct-testimonial-input-area">
                                                <input type="text" class="input-controller required" name="author_name" size="25" value="<?php echo esc_attr($row->author_name);?>" required="required"/>
                                            </div>
                                        </div>
                                        <div class="apct-testimonial-input-field">
                                            <label for="author_company"><?php _e( 'Company:', 'ap-custom-testimonial' ); ?></label>
                                            <div class="apct-testimonial-input-area">
                                                <input type="text" class="input-controller required" name="author_company" size="25" value="<?php echo esc_attr($testim_description['author_company']);?>" required="required"/>
                                            </div>
                                        </div>
                                        <div class="apct-testimonial-input-field">
                                            <label for="author_position"><?php _e( 'Position:', 'ap-custom-testimonial' ); ?></label>
                                            <div class="apct-testimonial-input-area">
                                                <input type="text" class="input-controller required" name="author_position" size="25" value="<?php echo esc_attr($testim_description['author_position']); ?>" required="required"/>
                                            </div>
                                        </div>                    
                                        <div class="apct-testimonial-input-field">
                                        ...
                                        <div class="apct-testimonial-input-field">
                                            ...
                                            <div class="apct-testimonial-input-area">
                                            <input type="email" class="input-controller required" name="author_email" size="25" value="<?php echo esc_attr($testim_description['author_email']);?>" required="required"/>
                                            </div>
                                        </div>                    
                                        <div class="apct-testimonial-input-field">
                                        ...
                                        <div class="apct-testimonial-input-field">
                                           ...
                                           <div class="apct-testimonial-input-area">
                                               <input id="apct_upload_image_url" type="text" name="apct_upload_image_url" value="<?php echo esc_url($testim_description['author_image_path']); ?>" class="input-controller required" required="required"/>
                                        ...
                                        <input type="hidden" name="current_testim_date" value="<?php if(isset($row->date)){ echo esc_attr($row->date); }?>"/>       
